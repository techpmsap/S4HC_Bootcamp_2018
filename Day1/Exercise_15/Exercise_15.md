...
<tr><td colspan=2><h1>EXERCISE 1_5 - IMPLEMENTING LOGICS FOR A CUSTOM BUSINESS OBJECT</h1></td></tr>
...
1. Go to the Extensibility tab and open the **Custom Business Objects** application  
	![](images/01.png)

1. Open the business object **Bonus PlanXX**  
	![](images/02.png)
...
For **published** Custom Business Objects **without a Draft version** you can implement logics.
...
1. Set the key field **ID** if still initial
	...
	Note: Replace XX with your workstation ID
...
1. Enter the consistency check coding.
	...
	* consistency check END
	```
1. At the end you should have a logic like this   
	![](images/11.png)
...
1. Enter following data
	...
	>NOTE: "employeeid" CBXXXXXXXXXX shall be the one of a sales person that created sales orders with a Net Amount of more than 3000.00 EUR in 2016 and that are completed. In this exercise, you can use **CB9980000008**. 

	This will look as follows. Click **OK**  
	![](images/13.png)
...
1. Click on **Go** and open the Bonus Plan with **ID 1**  
	![](images/25.png)
...
1. Save the Bonus plan. Save fails due to the validation error messages for missing percentages. Close the message  
	![](images/28.png)

1. Enter value **20** into field **High Bonus Percentage** and click **Save**  
	![](images/29.png)
	
1. Now the Bonus Plan is not rejected  
	![](images/30.png)
	
1. You can see that your business logic works as the Percentage Units and the Employee Name get filled. 	
	>Note: If you don't see the Employee Name, refresh the page and it will show.
